  ...
  },
  {
    ...
    dataFields: [
      ...
      { key: "target_date", requirement: "optional", valueType: "string (YYYY-MM-DD)" },
      {
        ...
        requirement: "optional",
        valueType: "number",
        hint: "0–100; omitido → API usa 50",
      },
      {
        key: "sort_order",
        requirement: "optional",
        valueType: "number",
        hint: "Ordem na lista de KRs; omitido → 0",
      },
    ],
  },
  {
    type: "project",
    summary: "Projeto no workspace; pode ligar-se a um ciclo OKR (vistas por ciclo).",
    envelope: envCommon,
    dataFields: [
      { key: "title", requirement: "required", valueType: "string", maxLength: 500 },
      {
      ...
      },
      {
        ...
        valueType: "string",
        maxLength: 100,
        hint: "external_ref de um ciclo já existente (ex.: CYC-0001)",
      },
      {
        key: "estimation_unit",
        requirement: "optional",
        valueType: "enum",
        enumValues: ["hours", "story_points"],
        default: "hours",
        hint: "Unidade de estimativa das tarefas deste projeto",
      },
  ...
  },
  {
    ...
    dataFields: [
      ...
      { key: "description", requirement: "optional", valueType: "string", maxLength: 2000 },
      {
        ...
        requirement: "optional",
        valueType: "enum",
        enumValues: ["pending", "in_progress", "completed", "missed", "blocked"],
        default: "pending",
      },
      {
        key: "priority",
  ...
  },
  {
    ...
    dataFields: [
      ...
      },
      {
        ...
        requirement: "optional",
        valueType: "number",
        hint: "Se o projeto usa hours; ignorado se estimation_unit for story_points",
      },
      {
        key: "estimated_points",
        requirement: "optional",
        valueType: "number",
        hint: "Se o projeto usa story_points; ignorado se estimation_unit for hours",
      },
    ],
  },
];
