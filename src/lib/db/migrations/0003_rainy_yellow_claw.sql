...
CREATE INDEX "okr_cycles_workspace_idx" ON "okr_cycles" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "okr_cycles_status_idx" ON "okr_cycles" USING btree ("status");--> statement-breakpoint
CREATE INDEX "okr_groups_workspace_idx" ON "okr_groups" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "okr_kr_updates_key_result_idx" ON "okr_key_result_updates" USING btree ("key_result_id");--> statement-breakpoint
CREATE INDEX "okr_key_results_workspace_idx" ON "okr_key_results" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "okr_key_results_objective_idx" ON "okr_key_results" USING btree ("objective_id");--> statement-breakpoint
CREATE INDEX "okr_key_results_cycle_idx" ON "okr_key_results" USING btree ("cycle_id");--> statement-breakpoint
CREATE INDEX "okr_key_results_status_idx" ON "okr_key_results" USING btree ("status");--> statement-breakpoint
CREATE INDEX "okr_objectives_workspace_idx" ON "okr_objectives" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "okr_objectives_cycle_idx" ON "okr_objectives" USING btree ("cycle_id");--> statement-breakpoint
CREATE INDEX "okr_objectives_status_idx" ON "okr_objectives" USING btree ("status");